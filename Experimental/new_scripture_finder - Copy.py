...
class ScriptureFinder(object):
    ...
    # Main extraction. Creates a list of scriptures. Each item will be from the same book, but may have multiple verses.
    def run(self, source):
        ...
        print(self.scripture_list)
        print(self.count_retrieved)
